window.catalog = [
  {
    ...
    colors: [],
    sizes: [],
    thumbnail: "../img/monki-festival-knitted.png", // replace with path to image extracted from catalog layout
  ...
  },
  {
    ...
    colors: ["Black", "White"],
    sizes: ["UK 18"],
    thumbnail: "../img/boyfriend-t-shirt-with-bohemian-print.png", // replace with image extracted from item layout
    preview: ["full image path 1", "full image path 2", "full image path 3"] // replace with paths to images extracted from item layout
  },
  {
    ...
    colors: [],
    sizes: [],
    thumbnail: "../img/boyfriend-t-shirt-with-paris-print.png", // replace with image extracted from item layout
    preview: ["full image path 1", "full image path 2", "full image path 3"] // replace with paths to images extracted from item layout
  },
  {
  ...
  },
  {
    ...
    colors: ["Blue"],
    sizes: ["UK 18"],
    thumbnail: "../img/levis-jeans-for-women.png", // replace with image extracted from item layout
    preview: ["full image path 1", "full image path 2", "full image path 3"] // replace with paths to images extracted from item layout
  },
  {
    ...
    colors: [],
    sizes: [],
    thumbnail: "../img/with-paychwork-crochet.png", // replace with image extracted from item layout
    preview: ["full image path 1", "full image path 2", "full image path 3"] // replace with paths to images extracted from item layout
  },
  {
  ...
  },
  {
    ...
    colors: ["Green"],
    sizes: ["UK 19"],
    thumbnail: "../img/neck-knitted-jumper.png", // replace with image extracted from item layout
    preview: ["full image path 1", "full image path 2", "full image path 3"] // replace with paths to images extracted from item layout
  },
  {
    ...
    sizes: ["UK 17"],
    thumbnail: "../img/only-skinny-jeans.png", // replace with image extracted from item layout
    preview: ["full image path 1", "full image path 2", "full image path 3"] // replace with paths to images extracted from item layout
  },
  {
    ...
    colors: [],
    sizes: [],
    thumbnail: "../img/turtle-neck-jumper-in-rib.png", // replace with image extracted from item layout
    preview: ["full image path 1", "full image path 2", "full image path 3"] // replace with paths to images extracted from item layout
  },
  {
    ...
    colors: ["Dark Blue"],
    sizes: ["UK 19"],
    thumbnail: "../img/only-busted-knee-jean.png", // replace with image extracted from item layout
    preview: ["full image path 1", "full image path 2", "full image path 3"] // replace with paths to images extracted from item layout
  },
  {
    ...
    colors: [],
    sizes: [],
    thumbnail: "../img/colour-block.png", // replace with image extracted from item layout
    preview: ["full image path 1", "full image path 2", "full image path 3"] // replace with paths to images extracted from item layout
  },
  {
    ...
    sizes: ["UK 18", "UK 19"],
    thumbnail: "../img/oversized-cardigan.png", // replace with image extracted from item layout
    preview: ["full image path 1", "full image path 2", "full image path 3"] // replace with paths to images extracted from item layout
  },
  {
    ...
    colors: ["Blue"],
    sizes: ["UK 18"],
    thumbnail: "../img/paul-&-joe-sister-jumper-with-neon-trims.png", // replace with image extracted from item layout
    preview: ["full image path 1", "full image path 2", "full image path 3"] // replace with paths to images extracted from item layout
  }
];
